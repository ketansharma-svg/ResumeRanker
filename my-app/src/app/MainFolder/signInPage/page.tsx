                ...
                "
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <label className="flex items-center gap-2 text-[#65756B]">
                                ...
                                I agree to the <span className="text-[#1DAFA1] underline cursor-pointer">Terms of Service</span> and <span className="text-[#1DAFA1] underline cursor-pointer">Privacy Policy</span>
                            </label>
